...
\begin{document}
  ...
  \begin{darkframes}
	...
	\item You will work in groups of 4---sign on Canvas by Sunday, March 25. You can create your own group or add to an existing group. Please fill partial groups before starting a new group.
