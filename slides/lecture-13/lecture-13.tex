...
\definecolor{shadecolor}{rgb}{0.137, 0.137, 0.137}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(model}\hlopt{$}\hlstd{fitted.values,} \hlkwd{resid}\hlstd{(model),}
...
(Intercept)  840065.15   99001.03    8.49        0
CRIME         -2566.08     663.82   -3.87        0
ZONE            922.00     276.22    3.34        0
NOX         -346925.67   71811.32   -4.83        0
ROOM          74242.52    8261.88    8.99        0
DIST         -31049.53    3784.98   -8.20        0
RADIAL         6000.24    1288.14    4.66        0
TAX            -265.33      68.57   -3.87        0
PTRATIO      -19279.75    2627.20   -7.34        0
LSTAT        -11071.73     957.48  -11.56        0
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{knitrout}
        ...
        \pause
        Reducing the pupil/teacher ratio (PTRATIO) by one could increase the median house price from \$14K to \$24K!
